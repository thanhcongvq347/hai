...
<body>
<form method="PUT" action="{{URL::to('/capnhat/' . $data->id)}}">
	@csrf
<div class="form-group">
<label for="exampleInputEmail1">Nhập tên sách</label>
<input type="text" name="ten" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="{{$data->ten_sach}}"> </div>
<div class="form-group">
